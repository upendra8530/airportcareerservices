      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
        ...
        <div>
          ...
          <div className="flex flex-col gap-3">
            <a href="tel:+91+91 95496 58894" className="flex items-center gap-2 text-sm text-primary-foreground/50 hover:text-secondary transition-colors">
              <Phone className="h-4 w-4" /> +91 95496 58894
            </a>
